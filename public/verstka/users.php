...
<head>
    ...
    <link id="vendorsbundle" rel="stylesheet" media="screen, print" href="/verstka/css/vendors.bundle.css">
    <link id="appbundle" rel="stylesheet" media="screen, print" href="/verstka/css/app.bundle.css">
    <link id="myskin" rel="stylesheet" media="screen, print" href="/verstka/css/skins/skin-master.css">
    <link rel="stylesheet" media="screen, print" href="/verstka/css/fa-solid.css">
    <link rel="stylesheet" media="screen, print" href="/verstka/css/fa-brands.css">
    <link rel="stylesheet" media="screen, print" href="/verstka/css/fa-regular.css">
</head>
    <body class="mod-bg-1 mod-nav-link">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            <a class="navbar-brand d-flex align-items-center fw-500" href="/users"><img alt="logo" class="d-inline-block align-top mr-2" src="/verstka/img/logo.png"> Учебный проект</a> <button aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarColor02" data-toggle="collapse" type="button"><span class="navbar-toggler-icon"></span></button>
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <?php if(isset($postsAsAdmin)):?>
                <?php foreach($postsAsAdmin as $user):?>
                <div class="col-xl-4">
                    <div id="<?= $user['id']?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $user['username'];?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <?php endif;?>
                                <a href="/page_profile/<?= $user['id'];?>"><span class="rounded-circle profile-image d-block " style="background-image:url('uploads/<?= $user['media'] ?? 'avatar-m.png';?>'); background-size: cover;"></span></a>
                                </span>
            ...
            <?php endforeach;?>
            <?php elseif(isset($postsAsUser)):?>
                <div class="col-xl-4">
                    <div id="c_2" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $postsAsUser['username'];?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <?php if($postsAsUser['online_status'] == 'online'):?>
                                <span class="status status-success mr-3">
                                <?php elseif($postsAsUser['online_status'] == 'walked_away'):?>
                                <span class="status status-warning mr-3">
                                <?php elseif($postsAsUser['online_status'] == 'do_not_disturb'):?>
                                <span class="status status-danger mr-3">
                                <?php endif;?>
                                    <a href="/page_profile/<?= $postsAsUser['id'];?>"><span class="rounded-circle profile-image d-block " style="background-image:url('uploads/<?= $postsAsUser['media'] ?? 'avatar-m.png';?>'); background-size: cover;"></span></a>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?= $postsAsUser['username'];?>
                                        <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                    </a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="/edit/<?= $postsAsUser['id'];?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="/page_security/<?= $postsAsUser['id'];?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="/status/<?= $postsAsUser['id'];?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/media/<?= $postsAsUser['id'];?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="/delete_user<?= $postsAsUser['id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                            <i class="fa fa-window-close"></i>
                                            Удалить
                                        </a>
                                    </div>
                                    <span class="text-truncate text-truncate-xl"><?= $postsAsUser['job'];?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="<?= $postsAsUser['phone'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?= $postsAsUser['phone'];?></a>
                                <a href="<?= $postsAsUser['email'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i><?= $postsAsUser['email'];?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i><?= $postsAsUser['adress'];?></address>
                                <div class="d-flex flex-row">
                                    <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                ...
                <div class="col-xl-4">
                    <div id="c_3" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="dr john cook">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-danger mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/verstka/img/demo/avatars/avatar-e.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        Dr. John Cook PhD
                ...
                <div class="col-xl-4">
                    <div id="c_4" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="jim ketty">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/verstka/img/demo/avatars/avatar-k.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        Jim Ketty
                ...
                <div class="col-xl-4">
                    <div id="c_5" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="aaron tellus">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/verstka/img/demo/avatars/avatar-g.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        Dr. John Oliver
                ...
                <div class="col-xl-4">
                    <div id="c_6" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="sarah mcbrook">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/verstka/img/demo/avatars/avatar-h.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        Sarah McBrook
                ...
                <div class="col-xl-4">
                    <div id="c_7" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="jimmy fellan">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/verstka/img/demo/avatars/avatar-i.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        Jimmy Fellan
                ...
                <div class="col-xl-4">
                    <div id="c_8" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="arica grace">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/verstka/img/demo/avatars/avatar-j.png'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        Arica Grace
    ...
    <script src="/verstka/js/vendors.bundle.js"></script>
    <script src="/verstka/js/app.bundle.js"></script>
    <script>
